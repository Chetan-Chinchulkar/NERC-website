...
function sendEmailV($name,$email,$pwd){
         echo 'done';
      }
*/
...
function sendEmailV($conn,$name,$email,$regNum){
        ...
        //foreach($user as $key=>$value){
                ...
                $mail->addCC('nerc@iitg.ac.in', 'North-East Research Conclave 2022');
                //Set the subject line
                $mail->Subject = 'Acknowledgement for Registering as Visitor in North-East Research Conclave-2022';
                $content="
                <p style='font-size:12pt;font-family:'Times New Roman',serif;text-align:justify;'>
                Dear Representative,<br/><br/>

                Thank you for your interest as Visitor from ".$name.", in North-East Research Conclave. Your registration No. is: ".$regNum.".<br/>
                We will send you further details soon.<br/>
                For any future correspondence, please write to NERC Secretariat (nerc@iitg.ac.in) quoting your registration number.<br/><br/>
